...
export function runProgressionEvaluatorFixtures(): {
  ...
  const equipmentCases: {
    ...
    {
      name: 'CI. Beginner: glute bridges → single-leg glute bridges',
      expected: 'ready-for-next-variation',
      history: atTop('glute-bridges', 'Glute Bridges', 12),
      exerciseId: 'glute-bridges',
      equipment: ['none'],
    ...
    {
      name: 'CJ. Some experience: glute bridges → single-leg glute bridges',
      expected: 'ready-for-next-variation',
      history: atTop('glute-bridges', 'Glute Bridges', 12),
      exerciseId: 'glute-bridges',
      equipment: ['chair'],
    ...
    {
      name: 'CK. Experienced with a chair: single-leg bridges → single-leg hip thrusts',
      expected: 'ready-for-next-variation',
      history: atTop('single-leg-glute-bridges', 'Single-Leg Glute Bridges', 12),
      exerciseId: 'single-leg-glute-bridges',
      equipment: ['chair'],
      experience: 'experienced',
      expectedNextId: 'single-leg-hip-thrusts',
    },
    {
      name: 'CL. Experienced without a chair: single-leg bridges are the top',
      expected: 'at-max',
      history: atTop('single-leg-glute-bridges', 'Single-Leg Glute Bridges', 12),
      exerciseId: 'single-leg-glute-bridges',
      equipment: ['none'],
    ...
    {
      name: 'CM. Some experience with a chair: single-leg bridges are the top (hip thrusts are advanced)',
      expected: 'at-max',
      history: atTop('single-leg-glute-bridges', 'Single-Leg Glute Bridges', 12),
      exerciseId: 'single-leg-glute-bridges',
      equipment: ['chair'],
    ...
    {
      name: 'CN. Single-leg hip thrusts at their ceiling are at maximum',
      expected: 'at-max',
      history: atTop('single-leg-hip-thrusts', 'Single-Leg Hip Thrusts', 10),
    ...
    {
      name: 'CO. Single-leg hip thrusts without a chair stay at maximum',
      expected: 'at-max',
      history: atTop('single-leg-hip-thrusts', 'Single-Leg Hip Thrusts', 10),
      exerciseId: 'single-leg-hip-thrusts',
      equipment: ['none'],
    ...
    {
      name: 'CP. Beginner earns the step from good mornings into single-leg RDLs',
      expected: 'ready-for-next-variation',
      history: atTop('good-mornings', 'Good Mornings', 12),
      exerciseId: 'good-mornings',
      equipment: ['none'],
      experience: 'beginner',
      expectedNextId: 'single-leg-rdls',
    },
    {
      name: 'CQ. Experienced: good mornings → single-leg RDLs',
      expected: 'ready-for-next-variation',
      history: atTop('good-mornings', 'Good Mornings', 12),
      exerciseId: 'good-mornings',
      equipment: ['gym'],
    ...
    {
      name: 'CR. Single-leg RDLs at their ceiling are at maximum',
      expected: 'at-max',
      history: atTop('single-leg-rdls', 'Single-Leg RDLs', 10),
      exerciseId: 'single-leg-rdls',
      equipment: ['none'],
      experience: 'experienced',
      expectedNextId: null,
    },
    {
      name: 'CS. Beginner with a chair: single-leg bridges are the top',
      expected: 'at-max',
      history: atTop('single-leg-glute-bridges', 'Single-Leg Glute Bridges', 12),
      exerciseId: 'single-leg-glute-bridges',
      equipment: ['chair'],
    ...
    {
      name: 'CT. Beginner earns the step from reverse crunches into lying leg raises',
      expected: 'ready-for-next-variation',
      history: atTop('reverse-crunches', 'Reverse Crunches', 12),
      exerciseId: 'reverse-crunches',
      equipment: ['none'],
      experience: 'beginner',
      expectedNextId: 'lying-leg-raises',
    },
    {
      name: 'CU. Some experience: reverse crunches → lying leg raises',
      expected: 'ready-for-next-variation',
      history: atTop('reverse-crunches', 'Reverse Crunches', 12),
      exerciseId: 'reverse-crunches',
      equipment: ['none'],
    ...
    {
      name: 'CV. Some experience without a bar: lying leg raises are the top',
      expected: 'at-max',
      history: atTop('lying-leg-raises', 'Lying Leg Raises', 12),
    ...
    {
      name: 'CW. Some experience with a bar: lying leg raises → hanging knee raises',
      expected: 'ready-for-next-variation',
      history: atTop('lying-leg-raises', 'Lying Leg Raises', 12),
      exerciseId: 'lying-leg-raises',
      equipment: ['pull-up-bar'],
      experience: 'some-experience',
      expectedNextId: 'hanging-knee-raises',
    },
    {
      name: 'CX. Experienced with a bar: hanging knee raises → hanging leg raises',
      expected: 'ready-for-next-variation',
      history: atTop('hanging-knee-raises', 'Hanging Knee Raises', 10),
      exerciseId: 'hanging-knee-raises',
      equipment: ['pull-up-bar'],
      experience: 'experienced',
      expectedNextId: 'hanging-leg-raises',
    },
    {
      name: 'CY. Hanging leg raises at their ceiling are at maximum',
      expected: 'at-max',
      history: atTop('hanging-leg-raises', 'Hanging Leg Raises', 8),
    ...
    {
      name: 'CZ. No bar: hanging knee raises have no usable harder variation',
      expected: 'at-max',
      history: atTop('hanging-knee-raises', 'Hanging Knee Raises', 10),
      exerciseId: 'hanging-knee-raises',
      equipment: ['none'],
    ...
    {
      name: 'DA. No bar: hanging leg raises stay at maximum',
      expected: 'at-max',
      history: atTop('hanging-leg-raises', 'Hanging Leg Raises', 8),
      exerciseId: 'hanging-leg-raises',
      equipment: ['chair'],
    ...
    {
      name: 'DB. Beginner with a bar: lying leg raises are the top',
      expected: 'at-max',
      history: atTop('lying-leg-raises', 'Lying Leg Raises', 12),
      exerciseId: 'lying-leg-raises',
      equipment: ['pull-up-bar'],
    ...
    {
      name: 'DC. Beginner earns the step from crunches into tuck V-ups',
      expected: 'ready-for-next-variation',
      history: atTop('crunches', 'Crunches', 12),
      exerciseId: 'crunches',
      equipment: ['none'],
      experience: 'beginner',
      expectedNextId: 'tuck-v-ups',
    },
    {
      name: 'DD. Some experience: crunches → tuck V-ups',
      expected: 'ready-for-next-variation',
      history: atTop('crunches', 'Crunches', 12),
      exerciseId: 'crunches',
      equipment: ['none'],
    ...
    {
      name: 'DE. Experienced: tuck V-ups → V-ups',
      expected: 'ready-for-next-variation',
      history: atTop('tuck-v-ups', 'Tuck V-ups', 12),
      exerciseId: 'tuck-v-ups',
      equipment: ['none'],
      experience: 'experienced',
      expectedNextId: 'v-ups',
    },
    {
      name: 'DF. V-ups at their ceiling are at maximum',
      expected: 'at-max',
      history: atTop('v-ups', 'V-ups', 10),
      exerciseId: 'v-ups',
      equipment: ['none'],
      experience: 'experienced',
      expectedNextId: null,
    ...
    {
      name: 'DG. Some experience: tuck V-ups are the top (V-ups are advanced)',
      expected: 'at-max',
      history: atTop('tuck-v-ups', 'Tuck V-ups', 12),
      exerciseId: 'tuck-v-ups',
      equipment: ['none'],
